                                    ...
                                    <tr>
                                     ...
                                     <tr>
                                        <form action="includes/insert.inc.php" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div style="left:5px;padding-top:40px;" class="col-12 col-lg-12"><input type="date" id="day" name="day" placeholder="Birth Date" class="form-control" value="<?php echo $day_ ?>"><small class="form-text text-muted">Please enter driver's date of birth</small></div>
                                        </td>
                                        
                                        <td>
                                            <div style="padding-left: 50px;padding-top: 40px;"><button type="submit" name="change_dob" class="btn btn-primary btn-sm">Update</button> <a class="btn btn-danger btn-sm" href="profile.php">Cancel</a></div>
