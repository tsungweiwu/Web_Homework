                                ...
                                <div class="mx-auto d-block">
                                    ...
                                    <tr>
                                        <form action="includes/insert.inc.php" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div style="left:5px;padding-top:40px;" class="col-12 col-lg-12"><input type="text" id="address" name="address" placeholder="Address" class="form-control" value="<?php echo $address_ ?>">
                                        </td>
                                        
                                        <td>
                                            <div style="padding-left: 50px;padding-top: 40px;"><button type="submit" name="change_address" class="btn btn-primary btn-sm">Update</button> <a class="btn btn-danger btn-sm" href="profile.php">Cancel</a></div>
